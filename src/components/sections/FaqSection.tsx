  ...
  return (
    <SectionWrapper background="ivory">
      <div className="text-center mb-10">
        <span className="section-label mx-auto">Preguntas frecuentes</span>
        <AnimatedSection>
          <h2 className="mt-3" style={{ fontFamily: 'var(--font-display)' }}>
            Resolvemos tus dudas
          </h2>
          <p className="mt-3 text-[var(--color-muted)] max-w-xl mx-auto">
            Si no encuentras respuesta a lo que necesitas, escríbenos por WhatsApp o pásate por el taller.
          </p>
        </AnimatedSection>
      </div>

      <FaqAccordion limit={showAll ? undefined : 6} />
